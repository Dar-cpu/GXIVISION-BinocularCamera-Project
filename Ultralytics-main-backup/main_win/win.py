...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(1394, 754)
        mainWindow.setMouseTracking(True)
        mainWindow.setStyleSheet("background-image: url(:/img/icon/QQ图片20230515151925.png);\n"
"")
        ...
        self.groupBox_18.setStyleSheet("QFrame{\n"
...
"")
        ...
        spacerItem = QtWidgets.QSpacerItem(37, 39, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "GXIVISION yolov8双目测距定位系统"))
        self.label_4.setText(_translate("mainWindow", "GXIVISION yolo v8双目测距"))
        ...
        self.label_2.setText(_translate("mainWindow", "交并比(Iou)"))
        self.label.setText(_translate("mainWindow", "置信度(Conf)"))
        self.saveCheckBox.setText(_translate("mainWindow", "保存"))
